...
org-mode bookmark links, etc.) to also pick up bmkx's enhancements
when they call =bmkx-jump=, add this advice. This effectively replaces bookmark-jump with bookmark-x equivalent.
...
If you want programmatic callers (=consult-bookmark=, =helm-bookmark=,
org-mode bookmark links, etc.) to also pick up bmkx's enhancements
when they call =bmkx-jump=, add this advice:
...
| Command                                             | Key                    | Meaning                                  |
|-----------------------------------------------------+------------------------+------------------------------------------|
| =bmkx-all-tags-jump=                                  | =C-x j t *=             | Bookmark with all given tags.            |
